                ...
                <div>
                    ...
                    <select name="instructor_id"
                        ...
                        @foreach($instructors as $instructor)
                            <option value="{{ $instructor->id }}" {{ (string) old('instructor_id', $course->instructor_id) === (string) $instructor->id ? 'selected' : '' }}>
            ...
            <div class="pt-2 border-t border-slate-800">
                ...
                <div class="mt-1.5 max-w-xs relative rounded-lg border border-slate-700 bg-slate-950 overflow-hidden focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-500">
                    <input type="number"
                           ...
                           min="1"
                           value="{{ old('access_validity_days', $course->access_validity_days ?? 365) }}"
                           required
                           placeholder="365"
